...
using BookEF2.Models;

namespace BookEF2.Controllers
{
    public class TblBooksController : Controller
    {
        private readonly BooksContext _context;

        public TblBooksController(BooksContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> ShowBooks()
        {
              return _context.TblBooks != null ? 
                          ...
                          Problem("Entity set 'BooksContext.TblBooks'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BooksContext.TblBooks'  is null.");
            }
            var tblBook = await _context.TblBooks.FindAsync(id);
            if (tblBook != null)
            {
